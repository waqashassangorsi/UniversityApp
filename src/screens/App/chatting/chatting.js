...
const chatting = ({ signin, selectedLanguages,user, translation,route, }) => {
  ...
  console.log('dname is',dname,messagekey)
...
{messageshow !=''?
        ...
        />:
        <View  style={{marginHorizontal:10,marginTop:660,paddingBottom:15}}>
        <View style={{flexDirection:'row',marginHorizontal:10,alignItems:'center',marginBottom:10}}>
          <TouchableOpacity 
          onPress={()=>fixmessage(message1)}
           style={{marginLeft:0,  
            ...
            elevation: 1,}}>
          <Text style={{color:'black',fontWeight:'bold'}}>{message1}</Text>
          </TouchableOpacity>
         ...
         onPress={()=>fixmessage(message2)}
          style={{marginLeft:10,  
            ...
            elevation: 1,}}>
          <Text style={{color:'black',fontWeight:'bold',alignSelf:'center'}}>{message2}</Text>
          </TouchableOpacity>
        </View>
       ...
       onPress={()=>fixmessage(message3)}
        style={{marginLeft:10,  
            ...
            elevation: 1,}}>
          <Text style={{color:'black',fontWeight:'bold',alignSelf:'center'}}>{message3}</Text>
          </TouchableOpacity>
        </View>
        }
